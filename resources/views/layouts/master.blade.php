    ...
    <header class="blog-header py-3">
      <div class="row flex-nowrap justify-content-between align-items-center">
        ...
        <div class="col-4 text-center">
          <a class="blog-header-logo" style="color: #17a2b8 !important;" href="{{ route('products.index') }}">🛍️ EyefizShop</a>
        </div>
        <form action="{{ route('products.search') }}" class="d-flex mr-1">

<div class="form-group mb-0 mr-4">
<input type="text" name="q" class="form-control" placeholder="produit ou catégorie">
</div>
...
<footer class="blog-footer">
  <p>
    <a href="https://getbootstrap.com/">Jean de Dieu</a> - 🛒 Application E-Commerce avec Laravel 6
  </p>
  <p>
